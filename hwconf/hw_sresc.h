...
//
// main.c uses these if HW_HAS_PERMANENT_NRF is defined.
// encoder.c uses these if *_USR_HW_SPI_PINS is defined.
...
// Override dead time used on the PWM outputs.
// The gate driver handles this, so the STM32 drives a minimal amount of deadtime.
#define HW_DEAD_TIME_NSEC		100.0

// Override the dead time compensation value. This one is close to what's
// measured with a scope, and it gives the most consistent measured resistance
// values.
#define MCCONF_FOC_DT_US				0.35
...
#ifdef MCCONF_M_DRV8301_OC_MODE
#error
#endif
// This does cycle-by-cycle limiting. mc_interface.c checks the fault pin every
// cycle and then stops.
#define MCCONF_M_DRV8301_OC_MODE DRV8301_OC_LIMIT

#ifdef MCCONF_M_DRV8301_OC_ADJ
#error
#endif
// Default to maximum of 1V V_DS.
// This number gets divided by 2 and then used as VDS_LVL.
#define MCCONF_M_DRV8301_OC_ADJ		24

#ifdef MCCONF_DEFAULT_MOTOR_TYPE
#error
#endif
...
#ifdef MCCONF_L_LIM_TEMP_FET_START
#error
#endif
// The actual limit is reduced for acceleration.
#define MCCONF_L_LIM_TEMP_FET_START 85.0

#ifdef MCCONF_L_LIM_TEMP_FET_END
#error
#endif
// The actual limit is reduced for acceleration.
#define MCCONF_L_LIM_TEMP_FET_END 95.0
